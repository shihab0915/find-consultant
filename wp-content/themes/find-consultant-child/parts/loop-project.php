 ...
 *
 * @package Find-Consultants\Templates
 * @since 1.0.0
 */
?>
...
<div id="projects" class="container">
	...
	<div class="article-header row">
		<div class="article-title large-8 columns">
			<?php if ( is_tax() ) : ?>
				<h3><?php printf( __( 'Browsing - %s', APP_TD ), single_term_title( '', false ) ); ?></h3>
			<?php elseif ( ! is_search() && ! is_archive() ) : ?>
				<h3 class="fp_healine"><?php _e( 'Latest Projects', APP_TD ); ?></h3>
			<?php endif; ?>
		</div>
	</div>
    <div class="container">
...
<?php } else { ?>
	...
	<div class="article-header row">
		...
		<div class="article-title large-8 columns">
			...
			<?php elseif ( ! is_search() && ! is_archive() ) : ?>
				...
				<h3><?php _e( 'Latest Projects', APP_TD ); ?></h3>
	...
	<!-- ad space <?php hrb_display_ad_sidebar( 'hrb-project-ads' ); ?>-->
