...
<form action="<?php echo appthemes_get_registration_url( 'login_post' ); ?>" method="post" class="login-form register-form custom container" name="registerform" id="login-form">
		...
		<div class="row">
			<div class="large-6 columns form-field user-role-type">
				...
				<select name="role">
					...
					<option value="<?php echo esc_attr( HRB_ROLE_FREELANCER ); ?>"><?php _e( 'Consultant', APP_TD ); ?></option>
